    ...
    },
    {
        ...
        stages: [
             ...
             },
             {
                ...
                description: "Выберите ДВА действия (в данном формате выберите одно комбинированное или лучшее).",
                questions: [{
                    text: "Какие действия логично дополнят решение?",
                    options: [
                        "a) Визуализация ветвей алгоритма и Сбор логов по каждому шагу",
                        "b) Отключение автоматической проверки",
                        "c) Увеличение объёма теоретического текста",
                        "d) Только увеличение количества видео-лекций"
                    ],
                    correct: 0
                }]
             }
